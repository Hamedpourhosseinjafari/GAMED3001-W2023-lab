...
void PlayScene::Draw()
{
	...
	if(m_bDebugView)
	{
		...
		Util::DrawLine(m_pStarShip->GetTransform()->position, m_pStarShip->getLeftLoseEndPoint(), m_pStarShip->GetLineCOlour(0));
		Util::DrawLine(m_pStarShip->GetTransform()->position, m_pStarShip->GetMiddleLoseEndPoint(), m_pStarShip->GetLineCOlour(1));
		Util::DrawLine(m_pStarShip->GetTransform()->position, m_pStarShip->GetRightLoseEndPoint(), m_pStarShip->GetLineCOlour(2));
		Util::DrawLine(m_pStarShip->GetTransform()->position, m_pStarShip->GetRightRightLoseEndPoint(), m_pStarShip->GetLineCOlour(3));
		Util::DrawLine(m_pStarShip->GetTransform()->position, m_pStarShip->getLeftLeftLoseEndPoint(), m_pStarShip->GetLineCOlour(4));
		}
	}
...
void PlayScene::Update()
{
	...
	if(m_pStarShip->IsEnabled())
	{
		...
		//check each whisker to sse if its colliding with obstacle
		m_pStarShip->GetCollisionWhiskers()[0] = CollisionManager::LineRectCheck(m_pStarShip->GetTransform()->position, m_pStarShip->getLeftLoseEndPoint(), 
			boxStart, boxWidth, boxHeight);
		m_pStarShip->GetCollisionWhiskers()[1] = CollisionManager::LineRectCheck(m_pStarShip->GetTransform()->position, m_pStarShip->GetMiddleLoseEndPoint(), 
			boxStart, boxWidth, boxHeight);
		m_pStarShip->GetCollisionWhiskers()[2] = CollisionManager::LineRectCheck(m_pStarShip->GetTransform()->position, m_pStarShip->GetRightLoseEndPoint(),
			boxStart, boxWidth, boxHeight);
		m_pStarShip->GetCollisionWhiskers()[3] = CollisionManager::LineRectCheck(m_pStarShip->GetTransform()->position, m_pStarShip->GetRightRightLoseEndPoint(),
			boxStart, boxWidth, boxHeight);
		m_pStarShip->GetCollisionWhiskers()[4] = CollisionManager::LineRectCheck(m_pStarShip->GetTransform()->position, m_pStarShip->getLeftLeftLoseEndPoint(),
			boxStart, boxWidth, boxHeight);
...
void PlayScene::GUI_Function()
{
	...
	//whisker properties
	static float whisker_angle = m_pStarShip->GetWhiskersAngle();
